...
export const icons = {
  ...
  // Lambang WhatsApp digambar ulang bergaya stroke Lucide (Lucide tidak punya
  // ikon brand ini) supaya tetap satu bahasa visual dengan ikon lain.
  whatsapp: '<path d="M12 21a9 9 0 1 0-7.7-4.4L3 21l4.4-1.3A9 9 0 0 0 12 21z"/><path d="M9 9.5a.8.8 0 0 1 .8-.8h1l.6 1.6-.8.7a5.7 5.7 0 0 0 2.6 2.6l.7-.8 1.6.6v1a.8.8 0 0 1-.8.8A7 7 0 0 1 9 9.5z"/>',
