...
const allBots: Bot[] = [
  ...
  },
  {
    ...
    tagline: 'Satu bot, beberapa game seru. Dari deduksi sosial sampai simulasi bisnis idle.',
    description:
      'Vanillate Games adalah hub game Discord berbahasa Indonesia. Saat ini tersedia dua game: 🐺 Werewolf, game deduksi sosial klasik dengan mode Klasik dan Lanjutan hingga 54 role, dan 🥟 Tahu Bulat, simulasi bisnis idle bertema kuliner. Cukup satu bot untuk teman-temanmu bermain semuanya, dan lebih banyak game akan datang.',
    status: 'live',
    featured: false,
    category: 'Multi-Game Hub',
    seoTitle: 'Vanillate Games — Bot Multi-Game Discord (Werewolf & Tahu Bulat)',
    seoDescription:
      'Satu bot Discord, beberapa game berbahasa Indonesia. Main Werewolf (deduksi sosial, mode Klasik & Lanjutan hingga 54 role) dan Tahu Bulat (simulasi bisnis idle). Gratis, terus bertambah.',
    ...
    features: [
      ...
      'Slash command sederhana: /gamewerewolf, /gametahu, /help',
    ],
    commands: [
