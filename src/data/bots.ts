...
const allBots: Bot[] = [
  ...
  {
    slug: 'vanillate-games',
    thumbnail: '/bots/vanillate-games.png',
    name: 'Vanillate Games',
    shortName: 'Vanillate Games',
    tagline: 'Satu bot, tiga game. Deduksi sosial, simulasi bisnis idle, dan Life Sim RPG di Kota Vanillate.',
    description:
      'Vanillate Games adalah platform multi-game Discord berbahasa Indonesia. Di dalamnya ada tiga game aktif, yaitu Werewolf (deduksi sosial dengan katalog hingga 54 role modern berbasis engine data), Tahu Bulat (simulasi bisnis idle bertema kuliner), dan Vanillate Story (Life Simulation RPG dengan 4 area, 39 lokasi, 63 pekerjaan, dan 36 NPC berjadwal). Undang sekali, mainkan semuanya. Werewolf dan sesi ramai lain juga jadi cara mudah mengumpulkan anggota server untuk main bareng di satu channel.',
    status: 'live',
    featured: false,
    category: 'Multi-Game Hub',
    seoTitle: 'Vanillate Games, Platform Multi-Game Discord (Werewolf, Tahu Bulat, Story)',
    seoDescription:
      'Platform multi-game Discord berbahasa Indonesia. Werewolf dengan 54 role modern, Tahu Bulat (bisnis idle), dan Vanillate Story (Life Sim RPG di Kota Vanillate). Gratis, arsitektur modular, dirawat rutin.',
    ...
    icon: '◉',
    longIntro: [
      'Vanillate Games dirancang sebagai platform. Setiap game jadi modul mandiri, jadi penambahan game baru tidak mengganggu yang lain. Undang bot sekali saja, semua game langsung tersedia di server, dan game berikutnya muncul otomatis saat rilis tanpa perlu invite ulang.',
      'Werewolf adalah game deduksi sosial klasik dengan katalog hingga 54 role modern (21 Village, 13 Werewolf, 20 Neutral). Mode Klasik cocok untuk 4 sampai 12 pemain dengan 4 role dasar. Mode Lanjutan dipandu narator berbasis engine data, di mana setiap role adalah kombinasi kemampuan primitif (attack, protect, investigate, roleblock, control, dan lainnya) sehingga interaksi antar-role selalu konsisten. Karena butuh banyak pemain sekaligus, Werewolf jadi cara seru mengumpulkan anggota server untuk nongkrong bareng.',
      'Tahu Bulat adalah simulasi bisnis idle bertema kuliner paling Indonesia. Jual tahu, upgrade dari gerobak kayu sampai food truck, dan biarkan tokomu tetap menghasilkan bahkan saat kamu offline. Rebirth memberikan bonus permanen +20% yang menumpuk selamanya. Modul ini menjadi fondasi ekonomi platform.',
      'Vanillate Story adalah Life Simulation RPG single player. Kamu berperan sebagai perantau yang datang ke Kota Vanillate membawa beban utang keluarga kepada Bang Jul senilai 3.500.000 coin yang harus dilunasi dalam 7 minggu. Bekerja, berlatih skill, memancing, menjalin hubungan dengan 36 NPC, sampai membangun rumah tangga. Jalan hidupmu sepenuhnya milikmu.',
    ],
    features: [
      'Werewolf, deduksi sosial 4 sampai 12 pemain dengan mode Klasik dan Lanjutan hingga 54 role modern',
      'Tahu Bulat, simulasi bisnis idle dengan pendapatan offline hingga 8 jam dan Rebirth permanen',
      'Vanillate Story, Life Sim RPG dengan 4 area, 39 lokasi, 63 pekerjaan, dan 36 NPC berjadwal',
      'Engine Werewolf berbasis data dengan attack dan defense berjenjang serta resolusi malam yang konsisten',
      'Story punya hubungan bertahap dari teman, dekat, momen spesial, pacaran, menikah, sampai punya anak',
      'Satu bot dan satu invite saja, tiap game jadi modul terpisah dan game baru muncul otomatis',
    ],
    commands: [
      { name: '/gamewerewolf', description: 'Buka lobi Werewolf, kumpulkan pemain, lalu mulai' },
      { name: '/gametahu', description: 'Buka dashboard Tahu Bulat, semua fitur ada di sini' },
      { name: '/gamestory', description: 'Mulai perjalananmu di Kota Vanillate' },
      { name: '/help', description: 'Panduan lengkap di dalam Discord' },
    ],
    docsSlug: 'vanillate-games',
  },
  {
    slug: 'anonymous-chat',
  ...
  {
    slug: 'story',
    hidden: true, // Story sekarang jadi game di dalam Vanillate Games (hub). Data disimpan sebagai arsip.
