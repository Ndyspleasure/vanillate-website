...
const allBots: Bot[] = [
  ...
  },
  {
    ...
    tagline: 'Satu bot, banyak game. Deduksi sosial, simulasi bisnis, dan Life Sim RPG segera hadir.',
    description:
      'Vanillate Games adalah hub game Discord berbahasa Indonesia. Saat ini tersedia dua game: 🐺 Werewolf, deduksi sosial klasik dengan mode Klasik dan Lanjutan hingga 54 role, dan 🥟 Tahu Bulat, simulasi bisnis idle bertema kuliner. Menyusul segera: ✧ Vanillate Story, Life Simulation RPG di Kota Vanillate. Cukup satu bot untuk teman-temanmu bermain semuanya.',
    status: 'live',
    featured: false,
    category: 'Multi-Game Hub',
    seoTitle: 'Vanillate Games — Bot Multi-Game Discord (Werewolf, Tahu Bulat, Story)',
    seoDescription:
      'Satu bot Discord, banyak game berbahasa Indonesia. Main Werewolf (deduksi sosial, hingga 54 role) dan Tahu Bulat (simulasi bisnis idle). Vanillate Story (Life Sim RPG) segera hadir di bot yang sama. Gratis.',
    ...
    icon: '◉',
    longIntro: [
      'Vanillate Games dirancang sebagai rumah bagi game-game Vanillate Studio. Undang bot sekali, dan seluruh koleksi game langsung tersedia di servermu. Saat game baru rilis, kamu tidak perlu invite ulang — command baru muncul otomatis.',
      '🐺 Werewolf adalah game deduksi sosial klasik. Sekawanan serigala bersembunyi di antara warga; tiap malam ada yang jadi korban, tiap siang desa mengeksekusi satu tersangka. Mode Klasik untuk 4–12 pemain dengan 4 role dasar, mode Lanjutan menyediakan hingga 54 role modern dipandu narator dengan sistem giliran.',
      '🥟 Tahu Bulat adalah simulasi bisnis idle bertema kuliner paling Indonesia. Jual tahu, upgrade dari gerobak kayu sampai food truck, dan biarkan tokomu terus menghasilkan bahkan saat kamu offline. Rebirth memberikan bonus permanen yang menumpuk selamanya.',
      '✧ Vanillate Story menyusul sebagai Life Simulation RPG di Kota Vanillate. Mulai dari nol sebagai pendatang, bangun karier, kumpulkan harta, kenali NPC dengan cerita hidupnya masing-masing, sampai membangun rumah tangga. Jalan hidupmu sepenuhnya milikmu.',
    ],
    features: [
      '🐺 Werewolf: deduksi sosial 4–12 pemain, mode Klasik & Lanjutan hingga 54 role',
      '🥟 Tahu Bulat: simulasi bisnis idle dengan pendapatan offline hingga 8 jam',
      '✧ Vanillate Story (segera): Life Sim RPG dengan karier, NPC, rumah, dan romansa',
      'Narator otomatis di Werewolf: fase malam & siang berjalan dengan timer pas',
      'Rebirth Tahu Bulat dengan bonus permanen +20% yang menumpuk selamanya',
      'Satu bot, satu invite: tambah game baru muncul otomatis untuk semua server',
    ],
    commands: [
      ...
      { name: '/gamestory', description: 'Buka Vanillate Story — segera hadir, belum aktif' },
      { name: '/help', description: 'Panduan lengkap di dalam Discord' },
    ],
