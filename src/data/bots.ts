...
const allBots: Bot[] = [
  ...
  },
  {
    ...
    description:
      'Vanillate Games adalah platform multi-game Discord berbahasa Indonesia. Tiga game aktif: Werewolf (deduksi sosial dengan katalog hingga 54 role modern berbasis engine data), Tahu Bulat (simulasi bisnis idle bertema kuliner), dan Vanillate Story (Life Simulation RPG dengan 4 area, 39 lokasi, 63 pekerjaan, dan 36 NPC berjadwal). Undang sekali, mainkan semuanya.',
    status: 'live',
    featured: false,
    ...
    icon: '◉',
    longIntro: [
      'Vanillate Games dirancang sebagai platform: setiap game jadi modul mandiri, penambahan game baru tidak mengganggu yang lain. Undang bot sekali, semua game langsung tersedia di server, dan game berikutnya muncul otomatis saat rilis tanpa perlu invite ulang.',
      'Werewolf adalah game deduksi sosial klasik dengan katalog hingga 54 role modern (21 Village, 13 Werewolf, 20 Neutral). Mode Klasik untuk 4–12 pemain dengan 4 role dasar; mode Lanjutan dipandu narator berbasis engine data, di mana setiap role adalah kombinasi kemampuan primitif (attack, protect, investigate, roleblock, control, dll) sehingga interaksi antar-role selalu konsisten.',
      'Tahu Bulat adalah simulasi bisnis idle bertema kuliner paling Indonesia. Jual tahu, upgrade dari gerobak kayu sampai food truck, dan biarkan tokomu tetap menghasilkan bahkan saat offline. Rebirth memberikan bonus permanen +20% yang menumpuk selamanya. Modul ini menjadi fondasi ekonomi platform.',
      'Vanillate Story adalah Life Simulation RPG single player. Kamu perantau yang datang ke Kota Vanillate membawa beban utang keluarga kepada Bang Jul: 3.500.000 coin yang harus dilunasi dalam 7 minggu. Bekerja, berlatih skill, memancing, menjalin hubungan dengan 36 NPC, sampai membangun rumah tangga — jalan hidupmu sepenuhnya milikmu.',
    ],
    features: [
      'Werewolf: deduksi sosial 4–12 pemain, mode Klasik & Lanjutan hingga 54 role modern',
      'Tahu Bulat: simulasi bisnis idle dengan pendapatan offline hingga 8 jam & Rebirth permanen',
      'Vanillate Story: Life Sim RPG dengan 4 area, 39 lokasi, 63 pekerjaan, dan 36 NPC berjadwal',
      'Engine Werewolf berbasis data: attack/defense berjenjang, prioritas resolusi malam yang konsisten',
      'Story punya sistem hubungan bertahap: teman → dekat → momen spesial → pacaran → menikah → punya anak',
      'Satu bot, satu invite: setiap game jadi modul terpisah, tambah game baru muncul otomatis',
    ],
    commands: [
