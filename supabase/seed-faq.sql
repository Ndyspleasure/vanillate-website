...
values
  ('Vanillate Sambung Kata', 'sambung-kata', 'Cara bermain, mode, progression, event, dan daftar command Vanillate Sambung Kata.', 'sparkles', 'active', 10),
  ('Umum & Produk', 'umum', 'Pertanyaan seputar produk Vanillate secara umum: cara mulai, biaya, dan pembaruan.', 'circle-help', 'active', 20),
  ('Akun & Data', 'akun-data', 'Izin yang diminta, keamanan data, dan bagaimana progres berpindah antar komunitas.', 'shield', 'active', 30),
  ('Bantuan & Troubleshooting', 'bantuan', 'Langkah pertama saat ada kendala, dan cara mengirim laporan bug atau masukan.', 'life-buoy', 'active', 40)
...
Tidak perlu menghafal apa pun sebelum mulai. Semua mode dibuka dari satu command lewat tombol di dashboard.', 'active', 10),
...
- Kata berakhiran huruf langka (X, Q, Z, V) memberi bonus Coin dan damage tertinggi.', 'active', 20),
...
Menang berturut-turut membangun Win Streak. Milestone tertentu memberi bonus Coin dan reward. Streak hilang jika kalah atau tidak menang. Cek streak kamu di `/stats`.', 'active', 30),
...
Lihat semua boost yang kamu miliki dengan `/inventory`. Boost otomatis muncul di tombol pre-match setelah kamu klaim atau beli.', 'active', 40),
...
- Bonus tambahan dari quest, win streak, dan passive class.', 'active', 50),
...
Setiap class punya talent eksklusif yang memberi bonus pasif saat bermain. Talent dibeli dengan Coin lewat `/class` → tombol talent. Cek talent yang tersedia dengan `/class info [nama_class]`.', 'active', 60),
...
Quest yang selesai diumumkan di akhir match — jangan lupa diklaim.', 'active', 70),
...
Harga di tabel ini mengikuti data shop yang berlaku di bot, jadi ikut berubah sendiri saat harga di dalam game diperbarui.', 'active', 80),
...
- Reward bervariasi: Coin, EXP, atau Boost.', 'active', 90),
...
- Tamat memberi drop pasti: Extra Life, boost acak, dan Dungeon Trophy.', 'active', 100),
...
Kunci habis dipakai setiap kali masuk Dungeon, dan kamu maksimal memegang 1 kunci.', 'active', 110),
...
Detail tiap event ada di FAQ terpisah pada kategori ini.', 'active', 120),
...
| Berakhir huruf langka (X / Z / Q / V) | +1 tambahan |', 'active', 130),
...
- Embed mencatat progres tiap fragmen: siapa mendapat apa, dari kata apa.', 'active', 140),
...
- **Golden Key:** jalur alternatif kalau ingin akses Dungeon Mode sekarang.', 'active', 150),
...
- Survival tunggal (dari ≥2 pemain manusia, tersisa 1) memberi gelar "Pengkhianat Perjuangan" dengan lore dramatis. Reward pemenang tetap ×2.', 'active', 160),
...
Buka dashboard game sampingan dengan `/game`, pilih game, lalu lobby dibuka di channel untuk mengajak yang lain bermain.', 'active', 170),
...
- `/masukan` — kirim saran atau laporan bug.', 'active', 180),
...
Kamu bisa mengecek sebuah kata kapan saja dengan `/kamus [kata]`.', 'active', 190),
  ('sambung-kata', 'Bisa main di berapa server?', 'main-di-banyak-server', 'Tidak terbatas. Progres, statistik, dan leaderboard bersifat global per pemain, jadi capaianmu terbawa ke server mana pun kamu bermain. Tidak ada biaya tambahan untuk memakainya di banyak server.', 'active', 200),
...
Contohnya, satu sesi Vanillate Sambung Kata di Discord bisa mendongkrak jumlah pesan sampai ratusan, sekaligus membantu anggota naik level di komunitas yang memakai sistem keaktifan.', 'active', 10),
  ('umum', 'Apakah produk Vanillate gratis?', 'apakah-gratis', 'Ya. Inti setiap produk kami bisa dipakai tanpa langganan wajib. Fitur Premium opsional hanya menambah kenyamanan, bukan syarat untuk menikmati bagian utamanya.', 'active', 20),
  ('umum', 'Bagaimana cara mulai memakai produknya?', 'cara-mulai-memakai', 'Buka halaman produk yang kamu inginkan, lalu ikuti tombol utamanya. Caranya menyesuaikan jenis produk: ada yang diundang ke komunitasmu, ada yang diunduh sebagai aplikasi, ada pula yang langsung dibuka lewat web. Setiap halaman produk menjelaskan langkahnya.', 'active', 30),
...
Bagi kami rilis adalah garis start, bukan garis finis, jadi produk terus dirawat setelah diluncurkan.', 'active', 40),
...
Untuk produk komunitas seperti Sambung Kata di Discord, izinnya sebatas mengirim pesan, menyematkan embed, membaca jawaban di channel permainan, dan mengelola komponen interaktif.', 'active', 10),
...
Detail lengkapnya bisa kamu baca di halaman [Kebijakan Privasi](/privacy).', 'active', 20),
  ('akun-data', 'Apakah progres saya terbawa antar komunitas atau perangkat?', 'progres-antar-komunitas', 'Ya. Progres, statistik, dan peringkat bersifat global per pengguna, jadi capaianmu terbawa ke mana pun kamu memakainya. Kamu juga bebas memakainya di sebanyak mungkin komunitas tanpa biaya.', 'active', 30),
  ('akun-data', 'Apakah progres saya bisa hilang?', 'progres-hilang', 'Tidak. Semua progres tersimpan otomatis di server dan tidak ada wipe berkala. Statistik, Class, dan inventory kamu tetap aman.', 'active', 40),
...
Kalau masih bermasalah, laporkan lewat [Support Center](/support) kami, dan orang yang menulis kodenya akan langsung membantu.', 'active', 10),
...
Kami membaca semua laporan, dan banyak fitur kami justru lahir dari usulan komunitas.', 'active', 20)
